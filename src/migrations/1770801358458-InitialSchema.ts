...
export class InitialSchema1770801358458 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "device_keys" ADD CONSTRAINT "FK_a3c1c936773e77775edd1f95f14" FOREIGN KEY ("deviceId") REFERENCES "user_device"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "device_keys" DROP CONSTRAINT "FK_a3c1c936773e77775edd1f95f14"`);
