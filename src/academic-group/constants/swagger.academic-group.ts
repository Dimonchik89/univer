import {
  ...
  GROUP_NOT_FOUND,
} from './academic-group.constants';

export const CREATE_ACADEMIC_GROUP_MESSAGE =
  'Successful academic group creation';
export const GROUP_BY_ID_NOT_FOUND_MESSAGE =
  'No academic group with this ID was found';
export const GROUP_BY_SLUG_NOT_FOUND_MESSAGE =
  'No academic group with this SLUG was found';
