...
export const CREATE_ROLE_SUMMARY =
  'Create New role (You need to add an administrator access_token or other users who have the required permissions)';
export const GET_ALL_ROLES_SUMMARY =
  'Get all roles and quantity (You need to add an administrator access_token or other users who have the required permissions)';
export const GET_ROLE_BY_ID_SUMMARY =
  'Get role by ID (You need to add an administrator access_token or other users who have the required permissions)';
export const UPDATE_ROLE_BY_ID_SUMMARY =
  'Update role name by ID (You need to add an administrator access_token or other users who have the required permissions)';
...
export const ROLE_DELETED_SUCCESS_EXAMPLE = {
  id: '13cbc2e3-7da5-4dbf-bc01-892affb23e24',
  success: true,
};
