...
export const GOOGLE_LOGIN_MESSAGE =
  'An endpoint for transitioning from a client to sign in or register using a Google account';
export const INCORRECT_EMAIL_OR_PASSWORD_MESSAGE =
  'Incorrect email or password';
export const FORGOT_PASSWORD_SUCCESS_MESSAGE =
  'Email with password reset link sent';
export const GENERATE_TOKENS_MESSAGE =
  'New access_token and refresh_token successfully generated';
...
export const REGISTRATION_SUCCESSFULLY_MESSAGE =
  'User successfully registered returns tokens';
export const GOOGLE_OAUTH_CALLBACK_MESSAGE =
  "Redirects to the application page adding the token to searchParams 'token'";
export const USER_NOT_FOUND_MESSAGE = 'User not found';
export const SIGNOUT_MESSAGE =
  'Logout (removes refresh token and push subscription)';
export const RESET_TOKEN_HAS_EXPIRED_MESSAGE =
  'Reset token has expired. Please request a new reset.';

export const GOOGLE_OAUTH_AUTHORIZATION =
  'Google OAuth — authorization initiation';
export const RESET_PASSWORD_USING_TOKEN =
